...
create_job "scraper-food-aus"        "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/food_pricing/run.py --country AUS"
create_job "scraper-food-nor"        "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/food_pricing/run.py --country NOR"
...
create_job "scraper-wages-aus"     "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/wages_and_employment/run.py --country AUS"
create_job "scraper-wages-nor"     "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/wages_and_employment/run.py --country NOR"
create_job "scraper-wages-eu27"    "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/wages_and_employment/run.py --country EU27"
echo "  ✓ 7 wages jobs created"
...
create_job "scraper-housing-aus"         "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/Housing_Supply_and_Shelter_Inflation/run.py --country AUS"
create_job "scraper-housing-nor"         "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/Housing_Supply_and_Shelter_Inflation/run.py --country NOR"
create_job "scraper-housing-eu27"        "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/Housing_Supply_and_Shelter_Inflation/run.py --country EU27"
echo "  ✓ 6 housing jobs created"
...
create_job "scraper-trade-aus"  "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/trade_flows/run.py --country AUS"
create_job "scraper-trade-nor"  "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/trade_flows/run.py --country NOR"
create_job "scraper-trade-eu27" "0 9,20 * * *" "${PYTHON} ${BASE}/scrapers/trade_flows/run.py --country EU27"
echo "  ✓ 6 trade jobs created"
