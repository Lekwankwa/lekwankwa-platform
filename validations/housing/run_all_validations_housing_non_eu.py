"""
Master Validation Runner — Non-EU Housing Supply & Shelter Inflation (GBR/CAN/AUS).
NOR excluded — no confirmed SSB residential property price table.
...
STAGES = [
    ...
    {"id": "4b", "name": "Temporal Coverage Audit", "script": "validations/temporal_coverage/temporal_validator.py",
                                                    "args": ["validations/temporal_coverage/config_housing_non_eu.json"], "required": True},
    ...
    {"id": "GX", "name": "Universal GX Validation", "script": "validations/gx_universal/universal_gx_validator.py",
                                                    "args": ["configs/gx_config_housing_non_eu_vault.json"], "required": True},
]

if __name__ == "__main__":
    sys.exit(run_pipeline(PRODUCT, STAGES, scope="non_eu_GBR_CAN_AUS", timeout=900))
