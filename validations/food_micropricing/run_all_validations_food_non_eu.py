"""
Master Validation Runner — Non-EU Food Micropricing (GBR/CAN/AUS/NOR).
...
STAGES = [
    ...
    {"id": "4b", "name": "Temporal Coverage Audit", "script": "validations/temporal_coverage/temporal_validator.py",
                                                    "args": ["validations/temporal_coverage/config_food_non_eu.json"], "required": True},
    ...
    {"id": "GX", "name": "Universal GX Validation", "script": "validations/gx_universal/universal_gx_validator.py",
                                                    "args": ["configs/gx_config_food_non_eu_vault.json"], "required": True},
]
