"""
Master Validation Runner — EU27 Wages & Employment (Eurostat SDMX).
...
BASE_US = "validations/wages_and_employment"
...
STAGES = [
    ...
    {"id": "4b", "name": "Temporal Coverage Audit",  "script": "validations/temporal_coverage/temporal_validator.py",
                                                     "args": ["validations/temporal_coverage/config_wages_eu27.json"], "required": True},
    ...
    {"id": 7,    "name": "Changelog Generation",     "script": f"{BASE_US}/changelog_generator_employment.py",
                                                     "args": ["--eu27"], "required": False},
    {"id": 8,    "name": "Lineage & Provenance",     "script": f"{BASE_US}/lineage_macro_employment.py",
                                                     "args": ["--eu27"], "required": False},
    {"id": "GX", "name": "Universal GX Validation",  "script": "validations/gx_universal/universal_gx_validator.py",
                                                     "args": ["configs/gx_config_wages_eu27_vault.json"], "required": True},
]
