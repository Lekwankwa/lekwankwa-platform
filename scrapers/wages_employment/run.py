...
def run_source(country: str, cfg: dict, source_filter: str | None,
    ...
    try:
        ...
        # Not every scraper's entry point supports the generic
        # mode/since interface — only pass through the arguments
        # the target function actually declares to avoid TypeErrors
        # like main() got an unexpected keyword argument 'mode'.
