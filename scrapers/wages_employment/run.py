...
def run_source(country: str, cfg: dict, source_filter: str | None,
    ...
    if dry_run:
        ...
        # Not every scraper module implements the full (mode, since, **kwargs)
        # interface. Inspect the target callable and only pass along the
        # optional arguments it actually accepts to avoid TypeErrors from
        # signature mismatches across heterogeneous scraper implementations.
