...
def send_approval_email(
    ...
    subject = (
        ...
        f"{product} / {country} — Layer 2 failed — approval required"
    )
...
Layer 1 (Validation/Audit): FAILED — exception detected
Layer 2 (Scrape4AI retry):  FAILED — all 3 retries exhausted
Layer 3 (Claude diagnosis):  COMPLETE — see below
...
<h3>Layer Status</h3>
<ul>
  <li>Layer 1 (Validation/Audit): <b>FAILED</b></li>
  <li>Layer 2 (Scrape4AI retry):  <b>FAILED</b> — 3 retries exhausted</li>
  <li>Layer 3 (Claude diagnosis):  <b>COMPLETE</b></li>
</ul>
